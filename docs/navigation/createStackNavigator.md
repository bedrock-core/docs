---
sidebar_position: 2
description: "Create a typed stack navigator."
---
...
`NavigationContainer` accepts an optional `initialState` prop for restoring a previously serialized navigation state (e.g. from persistent storage).
