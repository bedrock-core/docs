---
sidebar_position: 2
description: "core.registry is a live directory of every bedrock-core addon present in the world — the local addon plus every peer discovery can currently see."
---
...
Fires when **another instance is announcing this addon's namespace** — two packs both registered `creator` + `pack` with identical halves. The runtime also logs:
