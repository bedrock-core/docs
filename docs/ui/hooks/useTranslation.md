...
| --- | --- | --- |
| `instance` | `I18n<R>` | The addon's own `createI18n(bundle)` instance. Passing it is what keeps the verbs fully typed — selectors, interpolation arguments and plural leaves all come from that bundle's type |
