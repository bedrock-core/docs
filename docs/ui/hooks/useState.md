---
sidebar_position: 2
description: "Manage component state with reactive updates."
---
# useState
...
| --- | --- | --- |
| `initial` | `T \| (() => T)` (generic) | The initial value for the state variable, or a function that returns the initial value (lazy initialization) |
